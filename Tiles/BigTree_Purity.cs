...
namespace BigTree.Tiles
{
    class BigTree_Purity : ModTile
    {
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            {
                Texture2D tops = GetTexture("BigTree/Tiles/BigTree_Purity_Tops"); //Texture --- For the below line, it draws by x = middle, y = bottom origin. Adjust at your own risk
            ...
            {
                Texture2D tops = GetTexture("BigTree/Tiles/BigTree_Purity_Branches"); //Texture --- For the below line, it draws by x = right side, y = middle origin. Adjust at your own risk
            ...
            {
                Texture2D tops = GetTexture("BigTree/Tiles/BigTree_Purity_Branches"); //Texture --- For the below line, it draws by x = left side, y = middle origin. Adjust at your own risk
